...
-- }}}
-- Requires {{{
local ElementNode = load(makeRequest("https://raw.githubusercontent.com/msva/lua-htmlparser/refs/heads/master/src/htmlparser/ElementNode.lua","GET").content)()
local voidelements = load(makeRequest("https://raw.githubusercontent.com/msva/lua-htmlparser/refs/heads/master/src/htmlparser/voidelements.lua","GET").content)()
--}}}
local HtmlParser = {}
